...
<body>
                    ...
                    <?php if (isset($_SESSION['user'])) : ?>
                        <div style="margin-left: 50px; margin-top: 30px;">
                            ...
                            <?php if ($_SESSION['user']['role_id'] == 1) : ?>
                                <a href="./hang_hoa/index.php" class="btn btn-success">đến quản trị</a>
                            <?php endif; ?>
                        </div>
                    <?php else : ?>
    ...
    <nav class="nav nav-tabs" id="nav">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" href="https://localhost/du_an_Team/san_pham.php?loai=1" id="navbarDropdown">Sản phẩm</a>
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="card card-product mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <a href="./gio_hang/xl_gio.php?ma_sp=<?php echo $kq[$i]['ma_sp'] ?>" class="btn btn-success">THÊM VÀO GIỎ</a>
                            </div>
                        </div>
                    </div>
                <?php } ?>
