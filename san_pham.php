...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <form action="tim_kiem.php" method="get">
                <div class="input-group">
                    <input type="search" class="form-control rounded"  aria-label="Search" aria-describedby="search-addon" name="q" placeholder="Nhập từ khóa tìm kiếm" value="<?php
        ...
        <div class="gio_hang">
            <div class="hang"><img src="./logo/kisspng-shopping-cart-software-computer-icons-shopping-icon-5b3eb003bbc062.574139001530834947769-removebg-preview.png" alt="" width="80px">
                <div class="text_gio_hang"><a href="https://localhost/du_an_team/gio_hang/xem_gio.php"> Giỏ hàng</a></div>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-5">
        <h2 class="list-product-title"><?php echo $kq['0']['ten_loai'] ?></h2>
        <div class="product-group">
            <div class="row">
                <?php for ($i = 0; $i < count($kq); $i++) { ?>
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="card card-product mb-3">
                            <img class="card-img-top" src="<?php echo $kq[$i]['img'] ?>" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo $kq[$i]['ten_sp'] ?></h5>
                                <p class="card-text">Giá: <?php echo $kq[$i]['gia'] ?> VND</p>
                                <div class="mua"></div>
                                <a href="chi_tiet_sp.php?id=<?php echo $kq[$i]['ma_sp'] ?>" class="btn btn-primary">Chi Tiết</a>
                                <a href="chitietsp.php?id=<?php echo $kq[$i]['ma_sp'] ?>" class="btn btn-success">Mua sản phẩm</a>
                            </div>
                        </div>
                    </div>
                <?php } ?>
